                    ...
                    if src_port != 5001:
                        ...
                        if (src_ip, dst_ip, src_port) not in self.has_packetin_flow_list:
                            ...
                            if switch_resource[event.dpid] > 0:
                                ...
                                reject_flow_num += 1
                                ip_addr_hex = ip2hex(packet.next.dstip.toStr())
                                encap_sr_header_by_dip_sport_drop(event.dpid, ip_addr_hex,'FFffFFff',port2hex(src_port), 'FFff')
                            ...
                            output_action = pof.ofp_action_output(port_id=dst_outport)
